...
HD_PWD='D:/Programming/MODELSIM/four-choice-one-selector/four-choice-one-selector.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log selector41.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source selector41.tcl
